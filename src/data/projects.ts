export const projects = [
  ...
  },
  {
    ...
    description: 'Built a multi-category dashboard (7 domains: health, nutrition, etc.) using Ionic Vue, with 30+ dynamic features for real-time animal monitoring. Engineered RESTful APIs to sync frontend with backend, enabling data-driven health insights and reducing manual reporting by 40%.',
